            ...
            <div class="col-md-8">
                    ...
                    <div class="col-sm-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">Browse and manage all agencies and their accossiated
                                    caregivers.</p>
                    ...
                    <div class="col-sm-6 mt-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">A complete listing of caregivers from all of the available
                                    agencies.</p>
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        ...
                        <div class="mt-4">
                            @include('partials.caregiver-positions-chart', ['chart_data' => $dashBoardData['chart_data']])
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-12 mt-5">
                        ...
                        <table class="table table-sm mt-4">
                            ...
                            <tbody>
                            @foreach ($dashBoardData['table_data'] as $nurse)
                                <tr>
                                    <td>{{ $nurse->name }}</td>
                                    <td>{{ $nurse->license_number }}</td>
                                    <td>@include('partials.license-expiration',['license_expiration' =>  $nurse->license_expiration])</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
